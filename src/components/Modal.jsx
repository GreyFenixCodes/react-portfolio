  ...
  return (
    <div>    
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="aboutLabel">Welcome to my site!</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body bg-light">
                <p class="lead py-2">This site is not meant to be fancy.</p>
                <p class="lead">It is to display certain concepts, like a modal button or utilizing flex and grid with bootstrap, and also to display some sample projects.</p>
