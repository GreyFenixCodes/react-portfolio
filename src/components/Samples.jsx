            ...
            <div className="col-sm p-2">
                <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <a href="https://github.com/GreyFenixCodes/js-countdown-app/blob/main/script.js" target="_blank" className="btn btn-primary">SEE THE CODE</a>
                    </div>
                </div>
            </div>
            <div className="col-sm p-2">
                <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <a href="https://github.com/GreyFenixCodes/spac-invader-clone-python/blob/master/main.py" target="_blank" className="btn btn-primary">SEE THE CODE</a>
                    </div>
                </div>
            </div>
            <div className="col-sm p-2">
                <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <a href="https://github.com/GreyFenixCodes/portfolio/blob/main/index.html" target="_blank" className="btn btn-primary">SEE THE CODE</a>
                    </div>
                </div>
            </div>
            <div className="col-sm p-2">
